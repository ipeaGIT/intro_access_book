...
Além do R, o pacote `{r5r}` requer também a instalação do Java 11[^2]. Use o comando a seguir para checar a versão do Java instalada em seu computador.
...
4. O modelo digital de elevação da cidade: `poa_elevation.tif`; e
...
[^4]: Disponível em <https://github.com/ipeaGIT/accessibility>.
