...
[^3]: For more information on each parameter, please refer to the function documentation in an R session (with the commands `?travel_time_matrix` or `help("travel_time_matrix”)`) or on `{r5r}` [website](https://ipeagit.github.io/r5r/reference/travel_time_matrix.html).
...
[^4]: Available at <https://github.com/ipeaGIT/accessibility>.
