...
files_to_move <- c(
  "network.dat",
  "for_2020.osm.pbf.mapdb",
  "for_2020.osm.pbf.mapdb.p",
...
file.rename(paste0("before/", files_to_move), paste0(before_tmp, files_to_move))

after_tmp <- tempfile("after")
dir.create(after_tmp)
file.rename(paste0("after/", files_to_move), paste0(after_tmp, files_to_move))
```
...
#| results: false
#| warning: false
file.rename(paste0(before_tmp, files_to_move), paste0("before/", files_to_move))

file.rename(paste0(after_tmp, files_to_move), paste0("after/", files_to_move))
```
