...
# download dos dados
for_sf <- aopdata::read_landuse(city='fortaleza', 
                                year=2019, 
                                showProgress = FALSE, 
                                geometry = TRUE)
...
fig_renda <- 
  ggplot(data=subset(for_sf, P001 > 0)) +
