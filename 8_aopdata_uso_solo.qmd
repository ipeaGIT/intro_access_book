...
No exemplo a seguir, mostramos como baixar os dados de uso do solo do ano de 2019 para Belo Horizonte. Note que essa função resulta em uma tabela que também traz, automaticamente, os dados de população.
...
Por fim, a variável `C001` descreve a distribuição espacial de CRAS em cada cidade. O mapa a seguir apresenta essa distribuição em Belo Horizonte.
