...
tbl <- data.frame(
  ...
  Descrição = c(
	...
	"Apresenta o que é a especificação GTFS de dados de transporte público e mostra como trabalhar e analisar dados de GTFS usando o pacote `{gtfstools}`.",
	...
	"Mostra como baixar e visualizar os dados produzidos pelo projeto Acesso a Oportunidades, que incluem dados detalhados sobre padrões de uso do solo e acessibilidade nas vinte maiores cidades brasileiras."
  )
)
...
Este livro foi escrito e publicado com o sistema de publicação [Quarto](https://quarto.org). Todo o código utilizado em seu preparo e na sua publicação pode ser encontrado [neste repositório](https://github.com/ipeaGIT/intro_access_book). Para reproduzir o livro localmente, você deve primeiro baixar o seu código-fonte. Isso pode ser feito com o *software* [git](https://git-scm.com/) ou manualmente[^1]. Caso o segundo método seja utilizado, é necessário também extrair o conteúdo do arquivo `.zip` baixado para uma nova pasta.

[^1]: Para baixar o código-fonte manualmente, use o *link* a seguir: <https://github.com/ipeaGIT/intro_access_book/archive/refs/heads/main.zip>.
...
Para mais detalhes de como instalar as dependências do livro e rodar seu conteúdo localmente, veja as instruções completas de instalação no [repositório do livro](https://github.com/ipeaGIT/intro_access_book).
