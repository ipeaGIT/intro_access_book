...
```{r}
#| echo: false
#| label: fig-binder_badge

# knitr::include_graphics("images/binder_badge.svg")
htmltools::a(
...
::: {#fig-binder_badge.svg layout-ncol=1}

[![Elephant](images/binder_badge.svg)](https://mybinder.org/v2/gh/ipeaGIT/intro_access_book/HEAD?urlpath=rstudio)
