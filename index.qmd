...
tbl <- data.frame(
  ...
  Descrição = c(
	...
	"Por fim, a quinta seção mostra como baixar e analisar os dados do projeto Acesso a Oportunidades para analisar a distribuição espacial e socioeconômica das condições de acesso a oportunidades nas cidades brasileiras."
  )
)
