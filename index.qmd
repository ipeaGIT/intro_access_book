...
tbl <- data.frame(
  ...
  Descrição = c(
	...
	"Por fim, a quinta seção mostra como baixar e visualizar os dados produzidos pelo projeto Acesso a Oportunidades (AOP), que inclui dados detalhados sobre padrões de uso do solo e acessibilidade para as cidades brasileiras."
  )
)
